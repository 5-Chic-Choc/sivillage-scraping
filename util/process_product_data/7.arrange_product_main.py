...
# 원본 JSON 데이터를 읽어옵니다
with open('../merged_data/6.product_main_with_sizes.json', 'r', encoding='utf-8') as file:
...
def filter_used_fields(product):
    return {
        ...
        "colors": product.get("color_values"),
        "sizes": product.get("sizes"),
        "detail_iframe": product.get("src"),
...
with open('../merged_data/products.json', 'w', encoding='utf-8') as outfile:
